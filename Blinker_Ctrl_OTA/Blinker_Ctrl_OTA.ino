...
void button2_callback(const String & state) {
  ...
  if (state == "on") {
    ...
    //Button1.icon("far fa-door-closed");
...
void setup() {
  ...
  digitalWrite(GPIO2, HIGH); //初始化，由于继电器是低电平触发。所以刚开始设为高电平
  WIFI_Init();//调用WIFI函数
