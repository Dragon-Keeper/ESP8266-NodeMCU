...
#define DHTPIN 5  // 接NodeMCU D1 获取温湿度数据 Digital pin connected to the DHT sensor
//定义类型，DHT11或者其它
...
void loop()
{
  ...
  u8g2.drawGlyph(40, 16, 0x003A);
  //u8g2.setCursor(40, 16);
  //u8g2.print(t);
  u8g2.drawGlyph(60, 16, 0x2103);
  u8g2.setFont(u8g2_font_unifont_t_chinese2);
  u8g2.setCursor(0, 40);
  u8g2.print("湿度");
  u8g2.setFont(u8g2_font_unifont_t_symbols);   //先设置字体字集
  u8g2.drawGlyph(40, 40, 0x003A);
